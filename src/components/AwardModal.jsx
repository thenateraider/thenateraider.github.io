                ...
                >
                    ...
                    >
                        ...
                        <div className="p-6 sm:p-10 md:p-12 space-y-10 md:space-y-12">
                            ...
                            <div className="bg-white/[0.02] p-6 sm:p-8 md:p-10 rounded-3xl border border-white/5 shadow-inner">
                                {(award.by || award.desc) && (
                                    <div className="space-y-4 mb-8 pb-8 border-b border-white/5">
                                        {award.by && <p className="text-green-nate font-bold text-xl md:text-2xl tracking-wide drop-shadow-md">{award.by}</p>}
                                        {award.desc && <p className="text-gray-300 font-light text-lg md:text-xl leading-relaxed text-justify">{award.desc}</p>}
                                    </div>
                                )}

                                {award.details && (
                                    <ul className="space-y-6 list-none text-gray-200 text-lg md:text-xl font-light">
                                        {award.details.map((detail, i) => (
                                            <li key={i} className="flex items-start group">
                                                ...
                                                <span className="leading-relaxed tracking-wide group-hover:text-white transition-colors">{detail}</span>
                                            </li>
                                        ))}
                                    </ul>
                                )}
                            ...
                            {award.extraImages && award.extraImages.length > 0 && (
